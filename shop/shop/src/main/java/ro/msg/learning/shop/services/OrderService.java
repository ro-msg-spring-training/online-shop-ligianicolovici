...
public class OrderService {
    ...
    public OrderDTO createOrder(OrderDTO orderDTO){
        ...
        List<StockDTO> strategyResult = strategyConfiguration.decideStrategy().implementStrategy(orderDetailMapper.orderDetailListToOrderDetailDTOList(registerOrderedProducts(orderDTO.getOrderedProducts(),false)));
